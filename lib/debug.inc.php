 ...
 * @package EliKirk
 * @version $Id: debug.inc.php,v 1.3 2010/11/04 03:26:19 dave Exp $
 */

$GLOBALS['STARK_ENV_MODE'] = ( ($GLOBALS['STARK_MODE_BY_TRUSTED_IP'])
                         ? ( ( array_search($GLOBALS['STARK_TRUSTED_ALPHA_IPS'], $_SERVER['REMOTE_ADDR']) !== false ) ? 'alpha' : 'live' )
                         : ( isset($_SERVER['STARK_ENV_MODE']) ? $_SERVER['STARK_ENV_MODE'] : 'alpha')
                         );

$GLOBALS['BUG_ON']   = ( preg_match('/^alpha/', $GLOBALS['STARK_ENV_MODE']) ) ? true : false;
if ( defined("IS_DEV_SITE") ) $GLOBALS['BUG_ON'] = IS_DEV_SITE ? true : false;
